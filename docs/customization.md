...
| `view`              | `string`  | No         | `default`                      | Rendering mode: `default` (3D Monolith), `monthly` (Compact monthly stats), `heatmap` (flat 2D heatmap), `pulse` (heartbeat pulse), `skyline` (city skyline), or `languages` (top languages skyline) |
